  ...
  return (
    ...
    >
      <motion.div
        ...
        className="rounded-xl sm:rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
        style={{
      ...
      >
        <div className="p-4 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {services.map((service, index) => (
                  <button
                    ...
                    className={`p-2 sm:p-3 rounded-xl text-xs sm:text-sm transition-all ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 sm:p-3 rounded-xl focus:ring-2 focus:outline-none text-sm sm:text-base"
                  style={{
                    backgroundColor: 'var(--card-bg)',
                    color: 'var(--text-color)',
                    border: '1px solid var(--border-color)'
            ...
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: 'var(--text-color)' }}>
                <MessageCircle className="inline h-3 w-3 sm:h-4 sm:w-4 mr-1" />
            ...
            >
              <h3 className="font-semibold mb-2 text-sm sm:text-base" style={{ color: 'var(--text-color)' }}>
                Cost Summary
              </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 py-2 sm:py-3 rounded-xl font-semibold transition-colors text-sm sm:text-base"
                style={{
                  backgroundColor: 'var(--card-bg)',
                  color: 'var(--text-color)',
                  border: '1px solid var(--border-color)'
