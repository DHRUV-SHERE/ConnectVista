        ...
        switch (role) {
          ...
          case "provider":
            ...
            if (response.data.profile?.isVerified) {
              ...
              console.log("Provider not verified, redirecting to verification");
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-8 space-y-8">
          ...
          >
            ...
            >
              ...
              >
                Connect
                <span style={{ color: "var(--accent-fade)" }}>Vista</span>
              </span>
            </h2>
            <p
              className="text-lg"
            ...
            >
              Join thousands of service providers and seekers building stronger
